...
QT_MOC_LITERAL(3, 20, 12), // "MyTcpSocket*"
QT_MOC_LITERAL(4, 33, 8), // "mySocket"
QT_MOC_LITERAL(5, 42, 7) // "recvMsg"

    },
    "MyTcpSocket\0logout\0\0MyTcpSocket*\0"
    "mySocket\0recvMsg"
};
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logout((*reinterpret_cast< MyTcpSocket*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpSocket::logout)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::logout(MyTcpSocket * _t1)
{
